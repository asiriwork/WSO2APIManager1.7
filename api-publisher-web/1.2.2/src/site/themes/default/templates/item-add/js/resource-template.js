...
$( document ).ready(function() {
    ...
    $("#resource_view").on("draw", function(){
        ...
        var template = Handlebars.partials['resources']({ "resources": RESOURCES, "verbs": HTTP_VERBS, "scopes": SCOPES, "tiers": TIERS, "auth_types":AUTH_TYPES });
        var template2 = Handlebars.partials['scopes']({ "resources": RESOURCES, "verbs": HTTP_VERBS, "scopes": SCOPES, "tiers": TIERS , "auth_types":AUTH_TYPES});        
