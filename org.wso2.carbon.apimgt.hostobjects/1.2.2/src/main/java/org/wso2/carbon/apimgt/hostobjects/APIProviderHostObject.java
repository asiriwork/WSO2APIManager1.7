...
public class APIProviderHostObject extends ScriptableObject {
    ...
    public static boolean jsFunction_addAPI(Context cx, Scriptable thisObj,
        ...
        for (int k = 0; k < resources.size(); k++) {
            ...
            while (iterator.hasNext()) {
                ...
                Scope scope= findScopeByKey(scopeList,(String) mapEntryValue.get("scope"));
    ...
    private static Scope findScopeByKey(Set<Scope> scopes,String key){
        for(Scope scope:scopes){
            System.out.print(scope.getKey()+"--");
            ...
            if (api != null) {
                ...
                if (uriTemplates.size() != 0) {
                    ...
                    while (i.hasNext()) {
                        ...
                        resourceObj.put("http_verbs",ut.getResourceMap());
